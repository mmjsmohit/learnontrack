...
export function SwipeButton({
  ...
  return (
    <div
      ...
      role="button"
      aria-label={typeof props.children === "string" ? (props.children as string) : text}
      {...props}
    >
      <button
        ref={buttonRef}
        ...
        aria-label={isValidated ? "Validated" : (typeof props.children === "string" ? (props.children as string) : text)}
